...
int	t_previews_cell_norm_cases(t_cub3d **cub, int hyp, int i, int j)
{
	if (i == cub[0]->x && j < cub[0]->y)
	{
		cub[0]->ray_height[cub[0]->turn][3] = 1;
		cub[0]->text_x[cub[0]->turn] = ((int)(cub[0]->ray_pos[cub[0]->turn][1]) % 50);
	}
	...
	else if (j == cub[0]->y && i < cub[0]->x)
	{
		...
		cub[0]->text_x[cub[0]->turn] = ((int)(cub[0]->ray_pos[cub[0]->turn][0]) % 50);
	}
	else if (j == cub[0]->y && i > cub[0]->x)
	{
...
int	ft_previews_cell(t_cub3d **cub, int hyp, int i, int j)
{
	...
	if (t_previews_cell_norm_cases(cub, hyp, i, j))
		return (0);
	else if (cub[0]->turn > 0)
	{
		cub[0]->text_x[cub[0]->turn] = ((int)cub[0]->ray_height[cub[0]->turn - 1][1] % 50);
		cub[0]->ray_height[cub[0]->turn][3] = cub[0]->ray_height[cub[0]->turn - 1][3];
	}
	else
	{
		cub[0]->text_x[cub[0]->turn] = (cub[0]->ray_height[cub[0]->turn][1] % 50);
		cub[0]->ray_height[cub[0]->turn][3] = ft_chose_color(cub, cub[0]->turn);
	}
	if (cub[0]->turn == 1)
		cub[0]->ray_height[cub[0]->turn - 1][3] = cub[0]->ray_height[cub[0]->turn][3];
	return (0);
}
